...
package body GPR.Tree is
   ...
   package Next_End_Nodes is new GNAT.Table
   ...
   procedure Add_Comments
     (To       : Project_Node_Id;
      ...
      Zone     : Project_Node_Id := Empty_Project_Node;
   ...
   begin
      ...
      GPR.Ext.Initialize (Self.External);
   ...
   begin
      ...
      GPR.Ext.Initialize (Self.External, Copy_From => Copy_From.External);
      GPR.Env.Copy
        (From => Copy_From.Project_Path,
         To   => Self.Project_Path);
   ...
   begin
      return Node = Empty_Project_Node;
   end No;
   ...
   begin
      End_Of_Line_Node   := Empty_Project_Node;
      Previous_Line_Node := Empty_Project_Node;
      Previous_End_Node  := Empty_Project_Node;
   ...
   is
      Node : Project_Node_Id;
   begin
      Node := Default_Project_Node (Tree, N_Literal_String, GPR.Single);
      Set_Next_Literal_String (Node, Tree, Empty_Project_Node);
