...
package body GPR.Strt is
   ...
   begin
      ...
      if Token = Tok_Identifier then
         ...
         if Present (Reference) then
            declare
               Name : constant Name_Id := Name_Of (Reference, In_Tree);
            begin
               if Name = Snames.Name_Specification then
                  Set_Name_Of (Reference, In_Tree, To => Snames.Name_Spec);

               elsif Name = Snames.Name_Specification_Suffix then
                  Set_Name_Of
                    (Reference, In_Tree, To => Snames.Name_Spec_Suffix);

               elsif Name = Snames.Name_Implementation then
                  Set_Name_Of (Reference, In_Tree, To => Snames.Name_Body);

               elsif Name = Snames.Name_Implementation_Suffix then
                  Set_Name_Of
   ...
   procedure External_Reference
     (In_Tree         : Project_Node_Tree_Ref;
      ...
      Flags           : Processing_Flags)
   is
      Field_Id : Project_Node_Id := Empty_Project_Node;
   ...
   is
      Current_Choice : Project_Node_Id := Empty_Project_Node;
      Next_Choice    : Project_Node_Id := Empty_Project_Node;
   ...
   procedure Parse_Expression
     (In_Tree         : Project_Node_Tree_Ref;
      ...
      Flags           : Processing_Flags)
   is
      First_Term      : Project_Node_Id := Empty_Project_Node;
   ...
   procedure Parse_String_Type_List
     (In_Tree      : Project_Node_Tree_Ref;
      ...
      Flags        : Processing_Flags)
   is
      Last_String  : Project_Node_Id := Empty_Project_Node;
      Next_String  : Project_Node_Id := Empty_Project_Node;
   ...
   is
      ...
      Specified_Project : Project_Node_Id   := Empty_Project_Node;
      Specified_Package : Project_Node_Id   := Empty_Project_Node;
            ...
            case Names.Last is
               ...
               when 1 =>
                  ...
                  if No (The_Project) then
                     ...
                     First_Attribute := Attribute_First;
                     The_Package     := Empty_Project_Node;
                  end if;
   ...
   procedure Terms
     (In_Tree         : Project_Node_Tree_Ref;
      ...
      Flags           : Processing_Flags)
   is
      Next_Term          : Project_Node_Id := Empty_Project_Node;
      Term_Id            : Project_Node_Id := Empty_Project_Node;
      Current_Expression : Project_Node_Id := Empty_Project_Node;
      Next_Expression    : Project_Node_Id := Empty_Project_Node;
      Current_Location   : Source_Ptr      := No_Location;
      Reference          : Project_Node_Id := Empty_Project_Node;
